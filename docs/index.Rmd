...
If we look at the Histogram using our LIMIT_BAL variable it shows us the number of clients with a given credit balance in Taiwan Dollars. We can see that there is a large amount of clients with lower credit balances and a lower number of clients with higher credit amounts.
...
If we look at the Histogram using our AGE variable it shows us the number of credit card clients by age. We can see that the majority of clients are younger than 40 years of age.
...
Now that we have conducted all of our data management, and exploratory data analysis. The next part of our project is to conduct a logistical regression on our data. The logistical regression will allow us forecast what clients are likely to default on their next months credit card payment. We also want to determine what is a good cut-off point based on the predicted probability, 0.5? 0.4? 0.6? 

### Logistical Regression Quick Review
